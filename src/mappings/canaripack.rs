// TODO: general map => intermediate description => 1BitTDCanari tileset 2D position => 1D position
...
pub static GEN_TO_INTR_DESC: phf::Map<char, &'static str> = phf_map! {
    '.' => "ground",
    '#' => "wall",
    'd' => "creature: dog",
    '@' => "creature: human",
...
pub static CANARI_DESC_TO_2D: phf::Map<&'static str, (u8, u8)> = phf_map! {
    "black"                   => ( 1,  0),
    "boulder"                 => ( 6, 15),
    "brick wall: e"           => ( 9, 12),
    "brick wall: n"           => ( 8, 11),
